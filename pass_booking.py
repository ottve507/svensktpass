...
class PassBooking:
    ...
    #Constructor
    def __init__(self, early_time, late_time, emailaddr, telnumb, location_of_chrome_driver, start_page):
    ...
    def enter_names(self, driver, datetime_object):
        ...
        #Check in box that we want passport
        elem = driver.find_element_by_xpath("/html/body/div[2]/div/div/div/form/div[1]/div[5]/div/label[1]/input[1]")
        elem.click()
    ...
    def accept_boende(self,driver):
        try:
            ...
            elem = driver.find_element_by_xpath("//*[@id='ServiceCategoryCustomers_0__ServiceCategoryId']")
            elem.click()
            elem = driver.find_element_by_xpath("/html/body/div[2]/div/div/div/form/div[2]/input")
            elem.click()
